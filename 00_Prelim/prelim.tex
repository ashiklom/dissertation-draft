...
\title{Improving ecological forecasts using model and data constraints}
...
\reader{Second}{Mark Friedl, PhD}{Professor of Earth \& Environment}
\reader{Third}{Diane Thompson, PhD}{Assistant Professor of Earth \& Environment}
% \reader{Additional committee memeber}{Shawn Serbin, PhD}{Associate Ecologist}
